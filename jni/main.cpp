...
void LoadGLFunctions() {
    ...
    void* matrix4fv = aml->GetSym(hGLES, "glUniformMatrix4fv");
    void* matrix3fv = aml->GetSym(hGLES, "glUniformMatrix3fv");
    
    if(matrix4fv) {
        HOOK(glUniformMatrix4fv_Hook, matrix4fv);
        _glUniformMatrix4fv_real = (glUniformMatrix4fv_t)matrix4fv;
        logger->Info("Hooked glUniformMatrix4fv");
    }
    
    if(matrix3fv) {
        HOOK(glUniformMatrix3fv_Hook, matrix3fv);
